function [local_graph, F_now, norm_grad_F] = Optimization_RGN_linesearch_inverse_edge(local_graph, alpha_init, grad_tol, lambda_reg)
% This is the main function for optimization action
    ...
    [rgrad, rgnhess, F, ~] = rgn_gradhess_multi_J_forinverse(local_graph);
    ...
    while ~found
        ...
        [~, ~, F_can, ~] = rgn_gradhess_multi_J_forinverse(local_graph_candidate);
    ...
    [rgrad_final, ~, F_now, ~] = rgn_gradhess_multi_J_forinverse(local_graph);
