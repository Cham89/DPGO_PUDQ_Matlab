...
gt_g2o_file = 'C:\Users\hchen804\OneDrive - Georgia Institute of Technology\Desktop\2D_distributedPGO_Sandy\data\\grid_gt.g2o';
GT_graph = load_g2o_file_pudq_gt (gt_g2o_file);

odom_g2o_file = 'C:\Users\hchen804\OneDrive - Georgia Institute of Technology\Desktop\2D_distributedPGO_Sandy\data\grid_1.g2o';
...
while true
    ...
    [local_graph, F_now, norm_grad_F, Delta_out] = Optimization_RTR_inverse_edge(robot(r).local_graph, robot(r).Delta, grad_tol);
    
    robot(r).Delta = Delta_out; 
    robot(r).local_graph      = local_graph;
