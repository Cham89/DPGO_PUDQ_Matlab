function [eta, Heta, inner_it, stop_tCG] = manopt_tCG_new(x, grad, Hess, Delta, kappa, theta, P_x, maxinner)
...
for j = 1 : maxinner
    ...
    % getHessian(problem, x, mdelta, storedb, key);
    ...
    % Update the residual. (and ensure tangency)
    r = P_x*lincomb(1, r, -alpha, Hmdelta);
